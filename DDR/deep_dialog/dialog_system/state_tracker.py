...
class StateTracker:
    ...
    def back_state(self):
        self.history_vectors = copy.deepcopy(self.history_vectors_copy)
        self.history_dictionaries = copy.deepcopy(self.history_dictionaries_copy)
        self.current_slots = copy.deepcopy(self.current_slots_copy)
        self.turn_count = self.turn_count_copy

    def store(self):
        self.history_vectors_store = copy.deepcopy(self.history_vectors)
        self.history_dictionaries_store = copy.deepcopy(self.history_dictionaries)
        self.current_slots_store = copy.deepcopy(self.current_slots)
        self.turn_count_store = self.turn_count

    def recover(self):
        self.history_vectors = copy.deepcopy(self.history_vectors_store)
        self.history_dictionaries = copy.deepcopy(self.history_dictionaries_store)
        self.current_slots = copy.deepcopy(self.current_slots_store)
        self.turn_count = self.turn_count_store
    ...
    def update(self, agent_action=None, user_action=None):
        ...
        ########################################################################
        if agent_action:
            self.history_vectors_copy = copy.deepcopy(self.history_vectors)
            self.history_dictionaries_copy = copy.deepcopy(self.history_dictionaries)
            self.current_slots_copy = copy.deepcopy(self.current_slots)
            self.turn_count_copy = self.turn_count
            ####################################################################
