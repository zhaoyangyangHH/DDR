...
class AgentDQN(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None):
        ...
        self.StateIndexStore = StateIndexStore()
    ...
    def train(self, batch_size=1, num_batches=100, state_index_store={}):
        ...
        for iter_batch in range(num_batches):
            ...
            if isinstance(self.experience_replay_pool, Memory):
                ...
                # index = self.judge(batch, state_index_store)
                # if index:
                #     batch.append(self.experience_replay_pool.sample(1, index))
                #     batch.append(self.experience_replay_pool.sample(1, index+1))
    ...
    def judge(self, raw_batch, state_index_store):
        ...
        if self.StateIndexStore.has_state(s, state_index_store):
            index = self.StateIndexStore.get_index(s, state_index_store)
            return index
        else:
            return False